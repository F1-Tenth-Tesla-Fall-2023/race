...
trajectory_name     = 'raceline310_smooth'
...
def purepursuit_control_node(data):
    ...
    lookahead_distance = 5.70
    #steering_multiplier = 3.9
    steering_multiplier = 7.3

    #steering_multiplier = 7.15

    # 46 - 47 beginning of chicane
    # 67 - end of chicane
    if base_projection_index > 0 and base_projection_index < 115:
        lookahead_distance = 2.50
        steering_multiplier = 8.00
        in_chicane = True
        #print("chicane")
    else:
        in_chicane = False

    #if False and base_projection_index > 115 and base_projection_index < 150:
    #    lookahead_distance = 5
    #    steering_multiplier = 6.8

    #print("base_index = ", base_projection_index)
